...
public class Aiso8583serverTest {

    volatile static IsoMessage capturedRequest;
    @Test
    public void iso8583serverTesting() {
        try {
            ...
            final Iso8583Server<IsoMessage> server = new Iso8583Server<>(8585, configuration, messageFactory);
            ...
            server.addMessageListener(new IsoMessageListener<IsoMessage>() {
                ...
                public boolean onMessage(ChannelHandlerContext channelHandlerContext, IsoMessage isoMessage) {
                    ...
                    if (pan.startsWith("5")) {
                        // MasterCard
                        response.setField(15, IsoType.DATE10.value(new Date()));
                    }
